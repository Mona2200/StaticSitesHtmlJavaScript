function $advhover1() {
  ...
  advh1.insertAdjacentHTML('afterbegin', '<div class="adv_hover adv1" onmouseleave="$advout1()"><p class="adv_hover_text"><img src="../site2/img/check.png" alt="" height="15px" width="15px">Бесплатная консультация</p><p class="adv_hover_text"><img src="../site2/img/check.png" alt="" height="15px" width="15px">Подбор тура под ваши предпочтения</p><p class="adv_hover_text"><img src="../site2/img/check.png" alt="" height="15px" width="15px">Самостоятельный расчёт стоимости</p><p class="adv_hover_text"><img src="../site2/img/check.png" alt="" height="15px" width="15px">Учитываются все нюансы</p></div>')
}
function $advout1() {
  let advo1 = document.querySelector('.adv1')
  advo1.remove()
}

function $advhover2() {
  let advh2 = document.querySelector('#divadv')
  advh2.insertAdjacentHTML('afterbegin', '<div class="adv_hover adv2" onmouseleave="$advout2()"><p class="adv_hover_text"><img src="../site2/img/check.png" alt="" height="15px" width="15px">Широкий выбор отелей, мест, ресторанов и др.</p><p class="adv_hover_text"><img src="../site2/img/check.png" alt="" height="15px" width="15px">Можете выбрать тур по любой стране мира.</p></div>')
}
function $advout2() {
  let advo2 = document.querySelector('.adv2')
  advo2.remove()
}

function $advhover3() {
  let advh3 = document.querySelector('#divadv')
  advh3.insertAdjacentHTML('afterbegin', '<div class="adv_hover adv3" onmouseleave="$advout3()"><p class="adv_hover_text"><img src="../site2/img/check.png" alt="" height="15px" width="15px">Дружелюбный персонал</p><p class="adv_hover_text"><img src="../site2/img/check.png" alt="" height="15px" width="15px">Высококвалифицированные работники</p></div>')
}
function $advout3() {
  let advo3 = document.querySelector('.adv3')
  advo3.remove()
}

function $advhover4() {
  let advh4 = document.querySelector('#divadv')
  advh4.insertAdjacentHTML('afterbegin', '<div class="adv_hover adv4" onmouseleave="$advout4()"><p class="adv_hover_text"><img src="../site2/img/check.png" alt="" height="15px" width="15px">Готовы ответить в любое время суток</p><p class="adv_hover_text"><img src="../site2/img/check.png" alt="" height="15px" width="15px">Чёткое выполнение ваших просьб</p><p class="adv_hover_text"><img src="../site2/img/check.png" alt="" height="15px" width="15px">Отслеживание ваших отзывов</p></div>')
}
function $advout4() {
  let advo4 = document.querySelector('.adv4')
  advo4.remove()
}
