...
function $galleryimg_full(n) {
  ...
  pos.insertAdjacentHTML('afterbegin', '<img id="glrimg" src="../src/img/gallery_'+n+'.jpg" alt="'+n+'">')
  let ar = document.querySelector(".fullscreen")
  ar.insertAdjacentHTML('beforeEnd', '<img class="arrow_right" src="../src/img/arrow_right.png" alt="" height="20px" width="20px" onclick="$flipright('+n+')"><img class="arrow_left" src="../src/img/arrow.png" alt="" height="20px" width="20px" onclick="$flipleft('+n+')">')
